...
class MultiPerceptron:
    ...
    def predict(self, X):
        # jak pierszy perceptron zaliczy to do klasy 0
        return np.where(self.ppn1.predict(X) == 1, 0,
                        # jak drugi perceptron zaliczy to do klasy 2, a te pozostałe do klasy 1
...
class LogisticRegressionGD(object):
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_iter):
            ...
            # prawdopodobieństwo, że należy do klasy 1
            output = self.activation(net_input)
            # 1/0 to wartość naszej klasy - to prawdopodobieństwo, że należy do klasy 1
            errors = (y - output)
            # o ile zmieniamy * X = atrybut konkretny dla danej wagi (transponujemy ją) * (.dot) błędy,
    ...
    # wyliczane z jakim prawdopodobieństwem nam pasuje
...
def main():
    ...
    # X_train = atrybuty irysów do nauki
    # y_train = klasy irysów do nauki
    # X_train = atrybuty irysów do testowania
    # y_train = klasy irysów do testowania
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=1, stratify=y)

    # Pierwszy perceptron będzie nam znajdywać klase 0

    # klasy
    X_train_01_subset = np.copy(y_train)
    # usuwamy irysy o klasie 2
    ...
    # zmieniamy 1 na -1, a 0 na 1, ma to na celu, żebyśmy wytrenowali perceptron na odnajdywanie 0
    ...
    # Drugi perceptron będzie nam znajdywać klase 2, więc te irysy, które nie są zakwalifikowane do żadnego z perceptronó to te 1
    ...
    X_train_02_subset[(X_train_02_subset == 2)] = 1
    # tu dałem więcej uczenia, bo coś to nie dobrze wyglądało, jak było 10 iteracji
    ...
    # zmieniamy te irysy co ich nie chcemy znajdywać na 0, bo tu przyjmowane jest tylko od 0 do 1
